    ...
    <div className="flex min-h-screen bg-[#0E0E0C]">
      ...
      <div className="flex w-full flex-col items-center justify-center px-6 py-12 lg:w-[45%] lg:px-16">
        ...
        >
          ...
          {/* Security badge */}
          <div className="flex items-center justify-center gap-2 text-[#8A877D]">
          ...
          <div className="mt-4">
            ...
            <a
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.02] px-6 py-3 text-sm font-medium text-[#C8C6BC] transition-all hover:border-[#1D9E75]/30 hover:bg-white/[0.04]"
            >
