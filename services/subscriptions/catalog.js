...
const CATALOGO_SUSCRIPCIONES = [
  ...
  },
  {
    ...
    patrones: ['amazon prime', 'amzn prime', 'prime video'],
    icono: '📦',
    popular: true,
  },
  {
  ...
  // ─── CLOUD / ALMACENAMIENTO ───
  {
    ...
    patrones: ['google one', 'google storage', 'google drive'],
    icono: '☁️',
    popular: true,
  },
  {
  ...
  // ─── DELIVERY / FOOD (PERÚ) ───
  {
    ...
    patrones: ['rappi prime', 'rappiprime'],
    icono: '🛵',
    popular: true,
  },
  {
    ...
    patrones: ['pedidosya plus', 'pedidosyaplus'],
    icono: '🍔',
    popular: true,
  },
  {
