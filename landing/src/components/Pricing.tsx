...
const FEATURES: Feature[] = [
  ...
  { name: "Lectura de imágenes Yape/Plin", free: true, pro: true },
  { name: "Dashboard web", free: "Mes actual", pro: "Historial completo", highlight: true },
  { name: "Clasificación automática con IA", free: true, pro: true },
  { name: "Categorías personalizables", free: true, pro: true },
  { name: "Presupuestos", free: "Ilimitados", pro: "Ilimitados" },
  { name: "Metas de ahorro", free: "Ilimitadas", pro: "Ilimitadas" },
  ...
  { name: "Reportes PDF descargables", free: false, pro: true, highlight: true },
  { name: "Calendario financiero", free: false, pro: true },
  { name: "Heatmap de gastos", free: false, pro: true },
  { name: "Consejo IA personalizado", free: "1/semana", pro: "Ilimitado" },
