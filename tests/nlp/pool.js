...
module.exports = [
  ...
  { msg: '100 mangos en cevichería con los patas', intent: 'registrar_manual', cat: 'registro_jerga' },
  // #51 — marcador cada 50
  ...
  { msg: 'Me pagó mi tío 150 que me debía', intent: 'registrar_manual', cat: 'registro_ingreso' },
  ...
  { msg: 'Cuánto gasté este mes', intent: 'ver_total_gastado', cat: 'listar' },
  ...
  { msg: 'Gastos de transporte este mes', intent: 'listar_gastos_categoria', cat: 'listar' },
  ...
  { msg: 'Cuánto gasté en entretenimiento', intent: 'listar_gastos_categoria', cat: 'listar' },
  ...
  { msg: 'Cuánto he gastado en salud', intent: 'listar_gastos_categoria', cat: 'listar' },
  ...
  { msg: 'En qué se me va la plata', intent: 'ver_total_gastado', cat: 'listar' },
  ...
  { msg: 'Gastos del lunes al viernes', intent: 'ver_gastos_rango_fecha', cat: 'listar' },
  { msg: 'Todo lo que gasté ayer pe', intent: 'listar_gastos_dia', cat: 'listar' },
  { msg: 'Cuanto va el mes en comida', intent: 'listar_gastos_categoria', cat: 'listar' },
  ...
  { msg: 'Mis gastos de mascota', intent: 'listar_gastos_categoria', cat: 'listar' },
  ...
  // ══════════════════════════════════════════════════════════════
  { msg: 'Borra el último gasto', intent: 'eliminar_transaccion', cat: 'eliminar' },
  ...
  { msg: 'Borra el último q registré', intent: 'eliminar_transaccion', cat: 'eliminar' },
  ...
  // #181
  { msg: 'Los de Uber y DiDi van en transporte', intent: 'corregir_multiple', cat: 'corregir' },
  { msg: 'Corrige la categoría del almuerzo', intent: 'corregir_categoria', cat: 'corregir' },
  { msg: 'Eso de Bembos es comida rápida pe', intent: 'corregir_categoria', cat: 'corregir' },
  ...
  { msg: 'Los gastos de botica van en salud todos', intent: 'corregir_multiple', cat: 'corregir' },
  // #191
  { msg: 'Recategoriza el gasto del cine a ocio', intent: 'corregir_categoria', cat: 'corregir' },
  { msg: 'Lo de Vivanda es supermercado', intent: 'corregir_categoria', cat: 'corregir' },
  ...
  { msg: 'El almuerzo fue ayer no hoy', intent: 'editar_fecha', cat: 'editar' },
  { msg: 'Cambia la fecha del gasto al lunes', intent: 'editar_fecha', cat: 'editar' },
  // #201 — marcador cada 50
  { msg: 'Ese gasto fue el viernes', intent: 'editar_fecha', cat: 'editar' },
  { msg: 'Pon que el comercio es Wong no Metro', intent: 'editar_comercio', cat: 'editar' },
  { msg: 'Cambia el nombre a Tottus', intent: 'editar_comercio', cat: 'editar' },
  ...
  { msg: 'El gasto fue el 15 de marzo', intent: 'editar_fecha', cat: 'editar' },
  { msg: 'Cambia eso a dólares no soles', intent: 'corregir_monto_moneda', cat: 'editar' },
  { msg: 'El último fueron 200 dólares no soles', intent: 'corregir_monto_moneda', cat: 'editar' },
  ...
  { msg: 'Ese gasto fue antier', intent: 'editar_fecha', cat: 'editar' },
  { msg: 'El comercio es Bembos pe', intent: 'editar_comercio', cat: 'editar' },
  { msg: 'Cambia el del taxi a 8 dólares', intent: 'corregir_monto_moneda', cat: 'editar' },
  ...
  { msg: 'Ese gasto lo hice la semana pasada', intent: 'editar_fecha', cat: 'editar' },
  ...
  { msg: 'Le pagué 50 a Carlos de lo que le debía', intent: 'abonar_deuda', cat: 'deudas' },
  // #231
  { msg: 'Abono 30 a la deuda de Pedro', intent: 'abonar_deuda', cat: 'deudas' },
  { msg: 'Ya le pagué todo a María', intent: 'marcar_deuda_pagada', cat: 'deudas' },
  { msg: 'La deuda con José queda saldada', intent: 'marcar_deuda_pagada', cat: 'deudas' },
  { msg: 'Le di 100 a Luis de lo que le debo', intent: 'abonar_deuda', cat: 'deudas' },
  ...
  { msg: 'Ya pagué lo de Luis todo', intent: 'marcar_deuda_pagada', cat: 'deudas' },
  // #241
  ...
  { msg: 'Andrea me depositó 40 de lo que debía', intent: 'abonar_deuda', cat: 'deudas' },
  ...
  // ══════════════════════════════════════════════════════════════
  { msg: 'Cuánto me queda de presupuesto', intent: 'ver_presupuesto', cat: 'presupuestos' },
  ...
  { msg: 'Ver balance general', intent: 'ver_balance', cat: 'presupuestos' },
  { msg: 'Cuánto me falta para llegar al límite de comida', intent: 'ver_presupuesto', cat: 'presupuestos' },
  ...
  { msg: 'Quiero ver mi reporte semanal', intent: 'ver_reporte', cat: 'reportes' },
  ...
  { msg: 'Dame recomendaciones para ahorrar', intent: 'ver_recomendaciones', cat: 'reportes' },
  { msg: 'Cómo puedo gastar menos', intent: 'ver_recomendaciones', cat: 'reportes' },
  ...
  { msg: 'Reporte de gastos por categoría', intent: 'ver_reporte', cat: 'reportes' },
  // #291
  { msg: 'Exportar datos del último trimestre', intent: 'exportar_datos', cat: 'reportes' },
  { msg: 'Qué me recomiendas para mejorar mis finanzas', intent: 'ver_recomendaciones', cat: 'reportes' },
  ...
  { msg: 'Mándame el resumen de marzo', intent: 'compartir_resumen', cat: 'reportes' },
  ...
  { msg: 'Me encanta Neto genial servicio', intent: 'feedback', cat: 'social' },
  { msg: 'Está buenazo el bot', intent: 'feedback', cat: 'social' },
  { msg: 'Te falta esta función de split grupal', intent: 'feedback', cat: 'social' },
  ...
  { msg: 'Actualiza mi meta de fondo de emergencia', intent: 'editar_meta', cat: 'metas' },
  { msg: 'Elimina la meta de navidad', intent: 'eliminar_meta', cat: 'metas' },
  // #341
  { msg: 'Borra mi plan de viaje', intent: 'eliminar_meta', cat: 'metas' },
  ...
  { msg: 'Analiza si llego a mi meta de viaje', intent: 'viabilidad_plan', cat: 'metas' },
  ...
  { msg: 'Qué gastos puedo eliminar para llegar a mi meta', intent: 'sugerir_recortes', cat: 'metas' },
  ...
  { msg: 'Cuántos gastos he registrado este mes?', intent: 'ver_total_gastado', cat: 'edge_preguntas' },
  ...
  { msg: 'Ya superé mi presupuesto de comida?', intent: 'ver_presupuesto', cat: 'edge_preguntas' },
  ...
  { msg: 'Qué pasa si elimino un gasto por error?', intent: 'consulta_financiera', cat: 'edge_preguntas' },
  ...
  // #396
  { msg: 'Se puede conectar con mi banco?', intent: 'consulta_financiera', cat: 'edge_preguntas' },
  { msg: 'Qué categorías puedo usar?', intent: 'ver_categorias', cat: 'edge_preguntas' },
  { msg: 'Borro todos mis datos si desinstalo?', intent: 'consulta_financiera', cat: 'edge_preguntas' },
  { msg: 'Cuánto gasté más este mes que el anterior?', intent: 'comparar_meses', cat: 'edge_preguntas' },
  { msg: 'Puedo cambiar la moneda de un gasto?', intent: 'ayuda', cat: 'edge_preguntas' },
  // #401 — marcador cada 50
  { msg: 'Mis datos están seguros?', intent: 'consulta_financiera', cat: 'edge_preguntas' },
  { msg: 'Se puede usar en grupo familiar?', intent: 'consulta_financiera', cat: 'edge_preguntas' },
  { msg: 'Cómo agrego una meta de ahorro?', intent: 'como_empezar', cat: 'edge_preguntas' },
  ...
  // ══════════════════════════════════════════════════════════════
  { msg: '50', intent: 'registrar_manual', cat: 'edge_ambiguos' },
  { msg: 'Wong', intent: 'buscar_gasto', cat: 'edge_ambiguos' },
  { msg: 'Lo del taxi', intent: 'buscar_gasto', cat: 'edge_ambiguos' },
  { msg: 'Ayer', intent: 'listar_gastos_dia', cat: 'edge_ambiguos' },
  { msg: 'Comida', intent: 'listar_gastos_categoria', cat: 'edge_ambiguos' },
  ...
  { msg: 'El de 50', intent: 'buscar_gasto', cat: 'edge_ambiguos' },
  { msg: 'Cuánto', intent: 'ver_total_gastado', cat: 'edge_ambiguos' },
  // #416
  { msg: 'Y ahora cuánto me queda', intent: 'ver_balance', cat: 'edge_ambiguos' },
  { msg: 'Lo de María', intent: 'ver_deudas', cat: 'edge_ambiguos' },
  { msg: 'Ese no era', intent: 'eliminar_transaccion', cat: 'edge_ambiguos' },
  { msg: 'Ponle menos', intent: 'editar_monto', cat: 'edge_ambiguos' },
  { msg: 'Estoy misio', intent: 'ver_balance', cat: 'edge_ambiguos' },
  { msg: 'Mucho gasto', intent: 'ver_total_gastado', cat: 'edge_ambiguos' },
  { msg: 'El último no', intent: 'eliminar_transaccion', cat: 'edge_ambiguos' },
  { msg: 'Sí ese', intent: 'buscar_gasto', cat: 'edge_ambiguos' },
  { msg: 'El del chifa', intent: 'buscar_gasto', cat: 'edge_ambiguos' },
  { msg: 'Todo bien', intent: 'agradecimiento', cat: 'edge_ambiguos' },
  ...
  { msg: 'Quita el acceso a mi correo', intent: 'desconectar_cuenta', cat: 'moderacion' },
  ...
  { msg: 'Parte el gasto en 2', intent: 'dividir_gasto', cat: 'registro_basico' },
  { msg: 'Duplica el último gasto', intent: 'duplicar_gasto', cat: 'registro_basico' },
  { msg: 'Repite el gasto de ayer', intent: 'duplicar_gasto', cat: 'registro_basico' },
  ...
  { msg: 'Divide el de 100 soles en 4 partes', intent: 'dividir_gasto', cat: 'registro_basico' },
  ...
  { msg: 'El de 3500 es ingreso cámbialo', intent: 'marcar_como_ingreso', cat: 'registro_basico' },
